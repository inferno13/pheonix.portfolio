  ...
  var e = {
      ...
      1589: function (e, t, i) {
        var n = i(7854),
          ...
          l = Math.max
        e.exports = function (e, t, i) {
          for (var n = s(e), c = r(t, n), u = r(void 0 === i ? n : i, n), d = a(l(u - c, 0)), h = 0; c < u; c++, h++)
            o(d, h, e[c])
          return (d.length = h), d
        }
      },
      7475: function (e, t, i) {
        ...
        e.exports = function (e) {
          ...
          return (
            r(e) &&
              ((t = e.constructor),
              ((s(t) && (t === l || r(t.prototype))) || (o(t) && null === (t = t[a]))) && (t = void 0)),
            void 0 === t ? l : t
          )
        }
      },
        ...
        e.exports = function (e, t, i, o, p, m, L) {
          ...
          if (
            (M &&
              ...
              O.next &&
              (s || c(O) === _ || (u ? u(O, _) : a(O[w]) || f(O, w, S)), d(O, C, !0, !0), s && (g[C] = S)),
            v &&
              p == E &&
              I &&
              I.name !== E &&
          ...
          o(function () {
            ...
            ? function (e, t) {
                for (var i = u(e), r = arguments.length, o = 1, h = l.f, f = c.f; r > o; )
                  for (var g, m = d(arguments[o++]), v = h ? p(a(m), h(m)) : a(m), b = v.length, _ = 0; b > _; )
        ...
        ;(a[u] = !0),
          (e.exports =
            ...
            function (e, t) {
              var i
              return (
                null !== e ? ((d.prototype = r(e)), (i = new d()), (d.prototype = null), (i[u] = e)) : (i = p()),
                void 0 === t ? i : s.f(i, t)
              )
            })
      },
          ...
          ? o
            ? function (e, t, i) {
                if (
                  ...
                  (t = l(t)),
                  a(i),
                  'function' == typeof e && 'prototype' === t && 'value' in i && 'writable' in i && !i.writable)
                ) {
                  var n = d(e, t)
                  n &&
                    n.writable &&
            ...
            if (
              ...
              A
                ? r
                  ...
                  : (f.lastIndex = 0)
                : x && r && (f.lastIndex = f.global ? r.index + r[0].length : n),
              k &&
                r &&
                r.length > 1 &&
                s(g, r[0], i, function () {
            ...
            return [
              ...
              function (e, r) {
                ...
                for (var A, j = '', T = 0, C = 0; C < L.length; C++) {
                  for (var D = h((O = L[C])[0]), P = _(y(u(O.index), a.length), 0), I = [], N = 1; N < O.length; N++)
  ...
  ;(i.n = function (e) {
    ...
    (function () {
      ...
      function V(e) {
        ...
        return i && ('html' === O(i) || ('body' === O(i) && 'static' === B(i).position))
          ? t
          : i ||
              (function (e) {
      ...
      function Z(e) {
        ...
        if (p) {
          ...
          O === A(i) &&
            ...
            (O = O),
            (l === n || ((l === o || l === s) && c === u)) &&
              ((S = r), (y -= (m && L.visualViewport ? L.visualViewport.height : O[j]) - a.height), (y *= f ? 1 : -1)),
            (l !== o && ((l !== n && l !== r) || c !== u)) ||
              ((k = s), (b -= (m && L.visualViewport ? L.visualViewport.width : O[T]) - a.width), (b *= f ? 1 : -1))
        }
        var C,
        ...
        return (
          ...
          f
            ...
            : Object.assign(
                {},
                D,
                (((t = {})[S] = E ? y + 'px' : ''), (t[k] = x ? b + 'px' : ''), (t.transform = ''), t),
              )
        )
      }
      var ee = {
          ...
          : he(
              (function (e) {
                var t,
                  ...
                  l = -n.scrollTop
                return (
                  'rtl' === B(r || i).direction && (a += I(i.clientWidth, r ? r.clientWidth : 0) - s),
        ...
        ye = {
          ...
          fn: function (e) {
            var t = e.state,
              ...
              h = u.y
            null != t.modifiersData.popperOffsets &&
              ((t.modifiersData.popperOffsets.x += d), (t.modifiersData.popperOffsets.y += h)),
              (t.modifiersData[r] = c)
          },
        },
        we = {
      ...
      function Ee(e, t, i) {
        ...
        return (
          (s || (!s && !i)) &&
            (('body' !== O(t) || ce(a)) &&
              (c = (n = t) !== A(n) && T(n) ? { scrollLeft: (r = n).scrollLeft, scrollTop: r.scrollTop } : ae(n)),
      ...
      const Ce = 'transitionend',
        ...
        Fe = (e) =>
          Me(e) ? (e.jquery ? e[0] : e) : 'string' == typeof e && e.length > 0 ? document.querySelector(e) : null,
        Re = (e, t, i) => {
          Object.keys(i).forEach((n) => {
            ...
            if (!new RegExp(r).test(o))
              throw new TypeError(`${e.toUpperCase()}: Option "${n}" provided type "${o}" but expected type "${r}".`)
          })
        },
        ze = (e) =>
                ...
                return function n(r) {
                  ...
                  for (let { target: o } = r; o && o !== this; o = o.parentNode)
                    for (let a = s.length; a--; )
                      if (s[a] === o)
                        return (r.delegateTarget = o), n.oneOff && ht.off(e, r.type, t, i), i.apply(o, [r])
                  return null
                }
              })(e, i, n)
            : (function (e, t) {
      ...
      const ht = {
          ...
          trigger(e, t, i) {
            ...
            return (
              ...
              o
                ? ((d = document.createEvent('HTMLEvents')), d.initEvent(r, l, !0))
      ...
      class Nt extends gt {
        ...
        _getConfig(e) {
          return (
            (e = { ...St, ...xt.getDataAttributes(this._element), ...('object' == typeof e ? e : {}) }),
            Re(kt, e, Lt),
            e
          )
        }
        ...
        _addEventListeners() {
          this._config.keyboard && ht.on(this._element, 'keydown.bs.carousel', (e) => this._keydown(e)),
            'hover' === this._config.pause &&
              (ht.on(this._element, 'mouseenter.bs.carousel', (e) => this.pause(e)),
        ...
        _getItemIndex(e) {
          return (
            (this._items = e && e.parentNode ? Et.find('.carousel-item', e.parentNode) : []), this._items.indexOf(e)
          )
        }
        _getItemByOrder(e, t) {
          const i = e === Ot
      ...
      class Vt extends gt {
        ...
        _getConfig(e) {
          return (
            ((e = { ...Ft, ...xt.getDataAttributes(this._element), ...e }).toggle = Boolean(e.toggle)),
      ...
      class di extends gt {
        ...
        show() {
          ...
          this._inNavbar ? xt.setDataAttribute(this._menu, 'popper', 'none') : this._createPopper(t),
            'ontouchstart' in document.documentElement &&
              ...
              [].concat(...document.body.children).forEach((e) => ht.on(e, 'mouseover', qe)),
            this._element.focus(),
        ...
        _completeHide(e) {
          ht.trigger(this._element, 'hide.bs.dropdown', e).defaultPrevented ||
            ('ontouchstart' in document.documentElement &&
              [].concat(...document.body.children).forEach((e) => ht.off(e, 'mouseover', qe)),
        ...
        static dataApiKeydownHandler(e) {
          if (
            /input|textarea/i.test(e.target.tagName)
              ? e.key === Yt || (e.key !== Xt && ((e.key !== Kt && e.key !== Ut) || e.target.closest(ii)))
              : !Gt.test(e.key)
          )
            return
      ...
      class _i {
        ...
        _getConfig(e) {
          return (
            ((e = { ...gi, ...('object' == typeof e ? e : {}) }).rootElement = Fe(e.rootElement)),
            Re('backdrop', e, mi),
            e
          )
        }
      ...
      class Ri extends gt {
        ...
        _getConfig(e) {
          return (
            (e = { ...Oi, ...xt.getDataAttributes(this._element), ...('object' == typeof e ? e : {}) }),
            Re(Si, e, Ai),
            e
          )
        }
            ...
            this._queueCallback(
              () => {
                this._config.focus && this._focustrap.activate(),
                  (this._isTransitioning = !1),
                  ht.trigger(this._element, 'shown.bs.modal', { relatedTarget: e })
              },
              this._dialog,
              t,
            )
          ...
          this._isShown
            ? ht.on(this._element, Pi, (e) => {
                this._config.keyboard && e.key === Li
                  ...
                  : this._config.keyboard || e.key !== Li || this._triggerBackdropTransition()
              })
        ...
        _adjustDialog() {
          const e = this._element.scrollHeight > document.documentElement.clientHeight,
            ...
            i = t > 0
          ;((!i && e && !Qe()) || (i && !e && Qe())) && (this._element.style.paddingLeft = `${t}px`),
            ((i && !e && !Qe()) || (!i && e && Qe())) && (this._element.style.paddingRight = `${t}px`)
        }
        _resetAdjustments() {
      ...
      class Vi extends gt {
            ...
            this._queueCallback(
              () => {
                this._config.scroll || this._focustrap.activate(),
                  ht.trigger(this._element, 'shown.bs.offcanvas', { relatedTarget: e })
              },
              this._element,
              !0,
            ))
        ...
        _getConfig(e) {
          return (
            (e = { ...Bi, ...xt.getDataAttributes(this._element), ...('object' == typeof e ? e : {}) }),
            Re(zi, e, Wi),
            e
          )
        }
        ...
        show() {
          ...
          pt.set(n, this.constructor.DATA_KEY, this),
            this._element.ownerDocument.documentElement.contains(this.tip) ||
              (a.append(n), ht.trigger(this._element, this.constructor.Event.INSERTED)),
        ...
        setElementContent(e, t) {
          if (null !== e)
            return Me(t)
              ...
              : void (this._config.html
                  ? (this._config.sanitize && (t = Ki(t, this._config.allowList, this._config.sanitizeFn)),
                    (e.innerHTML = t))
                  : (e.textContent = t))
        }
        getTitle() {
          ...
          this._config.trigger.split(' ').forEach((e) => {
            if ('click' === e)
              ...
              ht.on(this._element, t, this._config.selector, (e) => this._enter(e)),
                ht.on(this._element, i, this._config.selector, (e) => this._leave(e))
            }
          }),
      ...
      class kn extends gt {
        ...
        _getConfig(e) {
          return (
            ((e = { ..._n, ...xt.getDataAttributes(this._element), ...('object' == typeof e && e ? e : {}) }).target =
              Fe(e.target) || document.documentElement),
            Re(bn, e, yn),
            e
          )
        }
      ...
      class Tn extends gt {
        ...
        show() {
          ...
          if (
            ht.trigger(this._element, 'show.bs.tab', { relatedTarget: e }).defaultPrevented ||
      ...
      class Fn extends gt {
        ...
        _getConfig(e) {
          return (
            (e = { ...Mn, ...xt.getDataAttributes(this._element), ...('object' == typeof e && e ? e : {}) }),
      ...
      var Un,
        ...
        tr = function (e) {
          ...
          var n =
            null === (i = null === (t = e) || void 0 === t ? void 0 : t.ownerDocument) || void 0 === i
              ? void 0
              : i.defaultView
        ...
        hr = function (e) {
          ...
          ;(this.target = e),
            ...
            (this.devicePixelContentBoxSize = Kn([t.devicePixelContentBoxSize]))
        },
        fr = function (e) {
          if (er(e)) return 1 / 0
                      ...
                      return (
                        Xn.some(function (e) {
                          ...
                          ('function' == typeof ErrorEvent
                            ...
                            : ((e = document.createEvent('Event')).initEvent('error', !1, !1), (e.message = Yn)),
          ...
          return (
            ...
            (e.observe = function (e, t, i) {
              ...
              Or(n.observationTargets, t) < 0 &&
                (r && Xn.push(n), n.observationTargets.push(new kr(t, i && i.box)), Er(1), xr.schedule())
            }),
      ...
      var Mr = (function () {
        function e(t, i) {
          ...
          ;(this.onScroll = function () {
            var e = Cr(n.el)
            n.scrollXTicking || (e.requestAnimationFrame(n.scrollX), (n.scrollXTicking = !0)),
              n.scrollYTicking || (e.requestAnimationFrame(n.scrollY), (n.scrollYTicking = !0))
          }),
                ...
                (t || i) &&
                  ...
                  'mousedown' === e.type &&
                    (t &&
                      ...
                      n.isWithinBounds(n.axis.x.scrollbar.rect) ? n.onDragStart(e, 'x') : n.onTrackClick(e, 'x')),
                    i &&
                      ((n.axis.y.scrollbar.rect = n.axis.y.scrollbar.el.getBoundingClientRect()),
                      n.isWithinBounds(n.axis.y.scrollbar.rect) ? n.onDragStart(e, 'y') : n.onTrackClick(e, 'y'))))
            }),
            (this.drag = function (t) {
              ...
              var l =
                ...
                (o - a)
              'x' === n.draggedAxis &&
                ((l = n.isRtl && e.getRtlHelpers().isRtlScrollbarInverted ? l - (r + s.size) : l),
                (l = n.isRtl && e.getRtlHelpers().isRtlScrollingInverted ? -l : l)),
          ...
          (t.positionScrollbar = function (t) {
            if ((void 0 === t && (t = 'y'), this.axis[t].isOverflowing)) {
              var i = this.contentWrapperEl[this.axis[t].scrollSizeAttr],
                ...
                l = ~~((n - s.size) * a)
              ;(l = 'x' === t && this.isRtl && e.getRtlHelpers().isRtlScrollbarInverted ? l + (n - s.size) : l),
                (s.el.style.transform = 'x' === t ? 'translate3d(' + l + 'px, 0, 0)' : 'translate3d(0, ' + l + 'px, 0)')
            }
          }),
              ...
              !(function e() {
                ...
                ;-1 === a
                  ? o > l &&
                    ...
                    i.contentWrapperEl.scrollTo((((r = {})[i.axis[t].offsetAttr] = o), r)),
                    n.requestAnimationFrame(e))
                  : o < l &&
                    ((o += i.options.clickOnTrackSpeed),
                    i.contentWrapperEl.scrollTo((((s = {})[i.axis[t].offsetAttr] = o), s)),
                    n.requestAnimationFrame(e))
              })()
            }
          }),
      ...
      class Br {
          ...
          document.querySelectorAll('[data-toggle="click-ripple"]:not(.js-click-ripple-enabled)').forEach((e) => {
            e.classList.add('js-click-ripple-enabled'),
              ...
              e.addEventListener('click', (t) => {
                ...
                ;(o = e.querySelector('.' + s)),
                  ('0px' !== getComputedStyle(o).height && '0px' !== getComputedStyle(o).width) ||
                  ...
                  (n =
                    ...
                    parseFloat(getComputedStyle(o).width.replace('px', '')) / 2),
                  (r =
                    t.pageY -
                    (e.getBoundingClientRect().top + window.scrollY) -
                    parseFloat(getComputedStyle(o).height.replace('px', '')) / 2),
                  (o.style.top = r + 'px'),
                  (o.style.left = n + 'px'),
            ...
            e.classList.add('js-table-checkable-enabled'),
              ...
              e.querySelectorAll('tbody input[type=checkbox], tbody input + label').forEach((t) => {
                t.addEventListener('click', (i) => {
                  ...
                  t.checked
                    ? e.querySelectorAll('tbody input[type=checkbox]:checked').length ===
                        e.querySelectorAll('tbody input[type=checkbox]').length && (n.checked = !0)
                    : (n.checked = !1),
                ...
                t.addEventListener('click', (t) => {
                  if (
                    ...
                    ;(n.checked = !n.checked),
                      ...
                      n.checked
                        ? e.querySelectorAll('tbody input[type=checkbox]:checked').length ===
                            e.querySelectorAll('tbody input[type=checkbox]').length && (i.checked = !0)
                        : (i.checked = !1)
                  }
                })
              })
        ...
        static jsCkeditor() {
          ...
          e &&
            ...
            t && (CKEDITOR.replace('js-ckeditor'), t.classList.add('js-ckeditor-enabled'))
        }
        static jsCkeditor5() {
          ...
          jQuery('.js-sparkline:not(.js-sparkline-enabled)').each((t, i) => {
            let n = jQuery(i),
              ...
              o = {
                ...
                pie: () => {
                  ;(s.type = r),
                    (s.sliceColors = ['#fadb7d', '#faad7d', '#75b0eb', '#abe37d']),
            ...
            o[r]
              ? (o[r](),
                'line' === r &&
                  ((n.data('chart-range-min') >= 0 || n.data('chart-range-min')) &&
                    (s.chartRangeMin = n.data('chart-range-min')),
                  (n.data('chart-range-max') >= 0 || n.data('chart-range-max')) &&
      ...
      ;(window.bootstrap = t),
        ...
        (window.Dashmix = new (class extends class {
            ...
            ;(t._lSidebar || t._lSideOverlay) &&
              ('init' === e
                ...
                : (e = 'custom-scroll') &&
                  ...
                  (t._lSidebar && !t._lSidebarScroll && (t._lSidebarScroll = new Fr(t._lSidebarScrollCon)),
                  t._lSideOverlay && !t._lSideOverlayScroll && (t._lSideOverlayScroll = new Fr(t._lSideOverlay))))
          }
          _uiHandleHeader() {
            let e = this
          ...
          _uiHandlePageLoader() {
            ...
            if ('show' === e)
              if (this._lpageLoader)
                t && ((this._lpageLoader.className = ''), this._lpageLoader.classList.add(t)),
          ...
          _uiHandleTheme() {
            ...
            document
              .querySelectorAll('[data-toggle="theme"][data-theme="' + (t ? t.getAttribute('href') : 'default') + '"]')
              .forEach((e) => {
          ...
          _uiApiBlocks() {
            let e,
              ...
              c = {
                init: () => {
                  document
                    .querySelectorAll('[data-toggle="block-option"][data-action="fullscreen_toggle"]')
                    .forEach((e) => {
                      e.innerHTML =
                        '<i class="si ' +
                        (e.closest('.block').classList.contains('block-mode-fullscreen') ? o : s) +
                        '"></i>'
                    }),
                    document
                      .querySelectorAll('[data-toggle="block-option"][data-action="content_toggle"]')
                      .forEach((e) => {
                        e.innerHTML =
                          '<i class="si ' +
                          (e.closest('.block').classList.contains('block-mode-hidden') ? l : a) +
                          '"></i>'
                      }),
            ...
            'init' === n
              ...
              : ((e = r instanceof Element ? r : document.querySelector(''.concat(r))),
                e &&
                  ((t = e.querySelector('[data-toggle="block-option"][data-action="fullscreen_toggle"]')),
